export const SR_IM_RATE_KEY = "Master|Sr. Implementation Manager";
...
export const BURDEN_RATE_KEY = "Master|Burden Rate";
export const INTERNAL_COST_RATE_KEY = "Master|Internal Cost Rate";

export const SCOPED_KEY_SR_IM = SR_IM_RATE_KEY;
